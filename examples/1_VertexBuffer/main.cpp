...
public:
    ...
    // Run loop that records and submits command buffers each frame
    void run() {
    ...
    // Record a command buffer every frame to use the vertex buffer
    void drawFrame() {
        ...
        // Re-record the command buffer for the current image
